...
var noRankMessage =
  serverMessageHeader + ChatColor.GRAY + "No swap available for rank: " + ChatColor.RESET;
var yourRankMessage = serverMessageHeader + ChatColor.GRAY + "Your Rank: " + ChatColor.RESET;

addCommand("rank", {
  onCommand: function (sender, args) {
    sender.sendMessage(Bukkit.getScheduler());
...
function lpCmdBuilder(sender, op, priority, text) {
  if (op === "add") {
    return "lp user " + sender.getName() + " meta addprefix " + priority + ' "' + text + ' "';
  } else {
